...
def timer(user, sudo):
    ...
    if choice == 'min':
        ...
        while clock >= 0:
            ...
            time.sleep(15)
            clock = clock - 1
            print("Only {} minute(s) remaining!!!".format(clock))
        print('''TIME
                        IS 
                              UP!!!
                              !!!!!!!!!
...
def Pass_INTERFACE1(tid):
    print("Welcome to AllyPrototype1. Your user name is your first name(not case sensative), and your password is your last name(case sensitive). Have a nice day, and thank you for choosing AllyPrototype1")
    time.sleep(1)
    user = input("Please give user name")
    pass1 = input("Please give password")
    if (user.lower() == "fred" and pass1 == "kuypers") or (user == "jon" and pass1 == "fuller"):
